...
import { LocalCategories } from '../models/localStorage';
...
export class CategoryService {
  ...
  // Returns a single category entry, based on the id (offline)
  getCategoryEntryOffline(id: string) {
    let current: Category = new Category();
